...
def item_order(order):
    ...
    orders = order.lower()
    count_salad = orders.count('salad')
    count_hamburger = orders.count('hamburger')
    count_water = orders.count('water')
    result = "salad:"+str(count_salad)+" hamburger:"+str(count_hamburger)+" water:"+str(count_water)
    return result